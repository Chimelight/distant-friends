...
正文各节只写**无时间戳的当下真相**：新认识改写进句子的自然位置，日期与来历归 git / §13 / 附录 E。不留"（某日澄清/勘正）"式补丁注记——补丁会沉积成地层（§5.7/§6.2 曾因此手术）；勘正标记至多存活一个版本周期。日期只属于账本节（§13 / §15 / 附录 E）。
...
2. 作者的朋友们——**同时来自多个国家**，可能不懂中文（UI 主语言是英文的由来）
3. 未来：任何想用它的人
...
- **v2.6**（2026-07-10）— §0 新增正文写法规则：各节只写无时间戳的当下真相，日期与来历归 git / §13 / 附录 E，不留补丁式注记（用户指出后确立）；§1 的多列对照理由从补丁注记改写为正文，为首个适用案例。
...
*文档版本 v2.6 · 最后更新 2026-07-10（§0 正文写法规则：无时间戳当下真相，补丁注记禁入正文——明细见附录 E）*
